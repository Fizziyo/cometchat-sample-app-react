...
APP_ID: "257963b32066a029", // Replace with your App ID
REGION: "IN", // Replace with your App Region ("eu" or "us")
AUTH_KEY: process.env.REACT_APP_COMETCHAT_API_KEY || ''// Replace with your Auth Key
}
...
//Initialize CometChta
CometChatUIKit.init(UIKitSettings)?.then(()=>{
    console.log('comet chat init done')
})
